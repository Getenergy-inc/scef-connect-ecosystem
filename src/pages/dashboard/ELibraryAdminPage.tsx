 ...
 * elibrary_resources table, which use the is_admin() function to verify admin status
 ...
 * 
 * See: RLS policy "Admins can manage resources" on elibrary_resources table
 */
import { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { supabase } from "@/integrations/supabase/client";
import { DashboardLayout } from "@/components/dashboard/DashboardLayout";
import { ELibraryAdmin } from "@/components/elibrary/ELibraryAdmin";
import { Loader2 } from "lucide-react";

const ELibraryAdminPage = () => {
  ...
  return (
    <DashboardLayout role="super_admin" title="eLibrary Management">
      <ELibraryAdmin />
    </DashboardLayout>
  );
};

export default ELibraryAdminPage;
