...
// Updated 2026 Programme Timeline — Phase 1: Award Campaign, Voting & Gala Journey (20 May → 22 Oct 2026)
const programmeTimeline = [
  {
    phase: "Public Pre-Nomination Activation",
    date: "20 May 2026",
    desc: "Launches the early public engagement phase through pre-nomination forms, graphics, and a weekly storytelling calendar — inviting Gen Z audiences across Africa, the diaspora, and friends of Africa to identify education changemakers before the official portal opens.",
    type: "awareness",
    active: true,
  },
  {
    ...
    desc: "Two-month nomination window for lifetime achievement entries. Scope: Africa Education Icon — Lifetime Achievement (2006–2026).",
    type: "deadline",
    active: false,
  },
  {
    ...
    desc: "Selected jury members complete orientation, governance review, conflict-of-interest guidance, and scoring calibration.",
    type: "governance",
    active: false,
  },
  {
    ...
    date: "5 July 2026",
    desc: "Launches the public season with baseline recognition of institutional and leadership impact across education.",
    type: "recognition",
    active: false,
  },
  {
    ...
    date: "10 July 2026",
    desc: "Final deadline for Influencers Education Impact Award entries before voting and category review.",
    type: "deadline",
    active: false,
  },
  {
    ...
    date: "12 July 2026",
    desc: "Honours transformational leaders whose work has shaped African education over the past two decades.",
    type: "recognition",
    active: false,
  },
  {
    ...
    desc: "Mass public voting phase across eligible categories using AGC participation credits, with regional activation and audience growth.",
    type: "voting",
    active: false,
  },
  {
    ...
    date: "22 August 2026",
    desc: "Official announcement of Influencers Education Impact Award 2026 Edition winners.",
    type: "recognition",
    active: false,
  },
  {
    ...
    desc: "A focused storytelling, media, partnership, and audience-building phase designed to carry visibility from the Gold Winners Show into the final Blue Garnet voting window.",
    type: "awareness",
    active: false,
  },
  {
    ...
    desc: "Final competitive voting window leading directly into the gala. Voting closes on gala day for transparency and suspense.",
    type: "voting",
    active: false,
  },
  {
    ...
    desc: "The peak event of the season — a live continental recognition ceremony and media moment celebrating Africa's education changemakers. Closes Phase 1; from 23 October 2026 the campaign transitions into the Rebuild My School Africa and EduAid-Africa social impact phase.",
    type: "gala",
    active: false,
  },
];
