...
const NAV: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Online Teaching Training Programme", href: "/programs/online-teaching-training", description: "Free training for Teacher Corps volunteers" },
      { name: "My Career My Life Services", href: "/programs/my-career-my-life", description: "Career guidance & mentorship" },
      { name: "Special Needs Schools Intervention", href: "/programs/special-needs-schools-intervention", description: "One school per region in 2027" },
      { name: "Edu-Tourism Missions", href: "/programs/edu-tourism-missions", description: "Regional education missions" },
      { name: "2027 Regional Waiting List & Grants", href: "/programs/2027-regional-waiting-list-grants", description: "Continental 2027 access pipeline" },
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Become an Ambassador", href: "/get-involved/ambassador", description: "Lead & represent SCEF" },
      { name: "Volunteer with Us", href: "/volunteer", description: "Campaigns, schools & media" },
