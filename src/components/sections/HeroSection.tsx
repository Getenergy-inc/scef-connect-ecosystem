...
const boardItems = [
  ...
  },
  {
    ...
    description: "Applications for the 2026 scholarship cycle are now open. Don't miss this opportunity!",
  ...
  },
  {
    ...
    description: "Africa Education & Productivity Certification now available across multiple regions.",
