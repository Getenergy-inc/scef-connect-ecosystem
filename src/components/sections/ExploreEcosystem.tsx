...
const items = [
  ...
  },
  {
    ...
    bullets: [
      "EduAid-Africa (includes RMSA, Training, Education Online Africa & My Career My Life)",
      "NESA-Africa · eLibrary Nigeria/Africa · SCEF Media",
      "Women & Girls Empowerment · Special Needs Education",
    ],
  ...
  {
    icon: GraduationCap,
    title: "EduAid-Africa Integrated Services",
    summary: "Training, RMSA, Education Online Africa and My Career My Life — all delivered under EduAid-Africa.",
    bullets: [
      "Monthly teacher training & school leadership (from July 2026)",
      "Education Online Africa — digital learning, certification, EOA Portal",
      "My Career My Life — JSS/SS career guidance (from August 2026)",
      "Rebuild My School Africa — infrastructure & school renovation",
    ],
    ctaLabel: "View EduAid-Africa Services",
    ctaHref: "/programs/eduaid-africa#integrated-services",
  },
  {
    icon: Heart,
    title: "Women & Girls Empowerment",
    summary: "Equal access, safe learning, mentorship and leadership pathways.",
    bullets: [
      "Scholarships and re-entry pathways for girls",
      "Mentorship, STEM and leadership programs",
      "Enterprise and career pipelines for young women",
    ],
    ctaLabel: "Support Women & Girls",
    ctaHref: "/programs/women-girls-education",
  },
  {
    icon: Wallet,
