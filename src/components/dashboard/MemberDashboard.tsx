...
import { 
  User, Wallet, Heart, MapPin, Award, BookOpen, 
...
export const MemberDashboard = ({ profile, user }: MemberDashboardProps) => {
  const quickStats = [
    ...
    { label: "Certifications", value: "0", icon: Award, color: "text-gold" },
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-earth to-earth/90 rounded-2xl p-6 text-cream">
